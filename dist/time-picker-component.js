...
var TimePickerComponent = (function () {
    ...
    TimePickerComponent.prototype.getCurrentHour = function () {
        var currentHour = this.isLeft ? this.selectedFromDate.get("hour") : this.selectedToDate.get('hour');
    ...
    TimePickerComponent.prototype.getCurrentMinute = function () {
        var currentMinute = this.isLeft ? this.selectedFromDate.get("minute") : this.selectedToDate.get('minute');
